<p align="center">
  <a href="https://github.com/Taha-Alavi/HudsonVpn" target="_blank" rel="noopener noreferrer">
    <picture>
...
<h1 align="center"/>هادسون سرویس</h1>

<p align="center">
فروش آسان با <a href="https://github.com/Taha-Alavi/HudsonVpn">هادسون سرویس</a> نصب فقط با یک دستور
</p>

<p align="center">
هادسون سرویس یک ربات قدرتمند و حرفه ای است که از چندین نوع پنل پشتیبانی می کند و بهترین گزینه برای فروش است، اکثر پروتکل ها را پشتیبانی می کند و نصب آسانی دارد. این ربات برای مردم عزیز ایران آماده شده است. یک جایگزین عالی برای فروش است تا بتوانید به راحتی کار خود را مدیریت کنید.
</p>
...
<br>
    <a align="center">
        <img src="https://github.com/Taha-Alavi/HudsonVpn/assets/27927279/c8e45ef9-2b4d-4a3e-aa5a-40df4f61abf3" />
    </a>     
<br>
<br>
...
```
bash <(curl -s https://raw.githubusercontent.com/Taha-Alavi/HudsonVpn/main/hudson.sh)
```
...
- بسیار خوب، پیام نصب ( ✅ ربات Hudson با موفقیت نصب شد! ) به ربات ارسال می شود.

<br>
<br>

## دستور آپدیت ربات - آپدیت پنل - بک آپ - حذف هادسون سرویس

- با هر به روز رسانی و بک آپ، یک اعلان برای ربات مدیر ارسال می شود


```
bash <(curl -s https://raw.githubusercontent.com/Taha-Alavi/HudsonVpn/main/update.sh)
```
...
- اگر با گرفتن کانکشن از ربات دچار stop شدن پنل شدید به خاطر این هست که تنظیمات ربات رو درست انجام ندادین برای ایجاد سرور و پلن میتونید از طریق این لینک آموزش رو دانلود کنید و انجام بدین
...
## Contact Developer
💎 Channel: https://t.me/hudsonservice
