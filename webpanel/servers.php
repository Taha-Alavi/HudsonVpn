...
<br>
            ...
            if (isset($_POST['btn_edit'])) {
                ...
                $sqlserver_config = "UPDATE server_config SET ip='$ip_server_0',panel_url='$panel_url_server_0',
                         sni='$sni_server_0',header_type='$header_type_server_0',request_header='$request_header_server_0',
                         response_header='$response_header_server_0',security='$security_server_0',tlsSettings='$tlsSettings_server_0',
                         username='$username_server_0',password='$password_server_0' WHERE id = '" . $value['id'] . "'";
                $resultserver_config = mysqli_query($conn, $sqlserver_config);

                $sqlserver_info = "UPDATE server_info SET title='$title_server_0',ucount='$ucount_server_0',remark='$remark_server_0',
                       flag='$flag_server_0' WHERE id = '" . $value['id'] . "'";
                $resultserver_info = mysqli_query($conn, $sqlserver_info);
                if (!$resultserver_config && !$resultserver_info) {
