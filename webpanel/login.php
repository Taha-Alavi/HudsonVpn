...
<head>
    ...
    <title>Login Panel HudsonService</title>
    <link
                ...
                <div class="" style="width: 65%">
                    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                        ...
                        <button value="Submit" type="submit" name="submit" style=" width:60px;border-radius: 50%"
                            ...
                            <svg class="mx-auto" xmlns="https://t3.ftcdn.net/jpg/04/54/09/98/360_F_454099801_32LqElT2W1vgRQ6YRsp3h2IsKQxTCnaG.jpg" id="Layer_1" data-name="Layer 1"
                        ...
                        <p style="font-size: 14px">HudsonService <span style="color:red;">
                                <svg class="inline-block" xmlns="https://cdn-icons-png.flaticon.com/512/5968/5968940.png" fill="#d8315b" id="Layer_1"
