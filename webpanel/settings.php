<!--
* WizWiz v7.5.3
* https://github.com/Taha-Alavi/HudsonVpn
...
<div class="px-6 my-2">
    <a href="https://github.com/Taha-Alavi/HudsonVpn" target="_blank">
        <button
...
>
    <div class="py-4 text-gray-500 dark:text-gray-400">
            ...
            <a class=" text-lg font-bold text-gray-800 dark:text-gray-200" href="index.php" > HudsonService <span class="px-1 ml-1 rounded" style="font-size: 10px;background-color: #e7cef1;color:#45013c !important;"> v 2.1</span></a>
            </div>
        <ul class="mt-6">
            <li class="relative px-6 py-3">
                <a
    ...
    <main class="h-full pb-16 overflow-y-auto">
        <div class="container grid px-6 mx-auto ">
            ...
            >
                ...
                <?php
                $sql = "SELECT value FROM setting WHERE id = 4";
                ...
                ?>
                    ...
                    <?php
                    if(isset($_POST['action']) && $_POST['action'] == 'save_pay') {
                        $zarin_names = $_POST["zarin_name"];
                        $nextpay_names = $_POST["nextpay_name"];
                        $nowpayment_names = $_POST["nowpayment_name"];
            ...
            <form id="save_state">
                    <div class="grid grid-cols-1 gap-6 mt-4 xl:grid-cols-8 lg:grid-cols-8 md:grid-cols-6 sm:grid-cols-6 text-left" style="font-size: 14px">
                        <div class="mt-2" >
                            <label class="text-gray-700 dark:text-gray-200 mt-2" for="requirePhone">requirePhone</label>
                        ...
                        <div class="mt-2">
                            <label class="text-gray-700 dark:text-gray-200 mt-2" for="requirePhone">requireIranPhone</label>
                            <input required name="requireIranPhone" value="<?php echo $datatwo["requireIranPhone"]; ?>" id="requirePhone"
                                   type="text"
                                   class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
                        </div>
                        <div class="mt-2">
                            <label class="text-gray-700 dark:text-gray-200 mt-2" for="requirePhone">sell</label>
                            <input required name="sellState" value="<?php echo $datatwo["sellState"]; ?>" id="requirePhone"
                                   type="text"
                                   class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
                        </div>
                        <div class="mt-2">
                            <label class="text-gray-700 dark:text-gray-200 mt-2" for="requirePhone">bot</label>
                            <input required name="botState" value="<?php echo $datatwo["botState"]; ?>" id="requirePhone"
                                   type="text"
                                   class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
                        </div>
                        <div class="mt-2">
                            <label class="text-gray-700 dark:text-gray-200 mt-2" for="requirePhone">search</label>
                            <input required name="searchState" value="<?php echo $datatwo["searchState"]; ?>" id="requirePhone"
                                   type="text"
                                   class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
                        </div>
                        <div class="mt-2">
                            <label class="text-gray-700 dark:text-gray-200 mt-2" for="requirePhone">cartToCart</label>
                            <input required name="cartToCartState" value="<?php echo $datatwo["cartToCartState"]; ?>" id="requirePhone"
                                   type="text"
                                   class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
                        </div>
                        <div class="mt-2">
                            <label class="text-gray-700 dark:text-gray-200 mt-2" for="requirePhone">nextpay</label>
                            <input required name="nextpay" value="<?php echo $datatwo["nextpay"]; ?>" id="requirePhone"
                                   type="text"
                                   class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
                        </div>
                        <div class="mt-2">
                            <label class="text-gray-700 dark:text-gray-200 mt-2" for="requirePhone">zarinpal</label>
                            <input required name="zarinpal" value="<?php echo $datatwo["zarinpal"]; ?>" id="requirePhone"
                                   type="text"
                                   class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
                        </div>
                        <div class="mt-2">
                            <label class="text-gray-700 dark:text-gray-200 mt-2" for="requirePhone">nowPaymentWallet</label>
                            <input required name="nowPaymentWallet" value="<?php echo $datatwo["nowPaymentWallet"]; ?>" id="requirePhone"
                                   type="text"
                                   class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
                        </div>
                        <div class="mt-2">
                            <label class="text-gray-700 dark:text-gray-200 mt-2" for="requirePhone">nowPaymentOther</label>
                            <input required name="nowPaymentOther" value="<?php echo $datatwo["nowPaymentOther"]; ?>" id="requirePhone"
                                   type="text"
                                   class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
                        </div>
                        <div class="mt-2">
                            <label class="text-gray-700 dark:text-gray-200 mt-2" for="requirePhone">wallet</label>
                            <input required name="walletState" value="<?php echo $datatwo["walletState"]; ?>" id="requirePhone"
                                   type="text"
                                   class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
                        </div>
                        <div class="mt-2">
                            <label class="text-gray-700 dark:text-gray-200 mt-2" for="requirePhone">Location</label>
                            <input required name="switchLocationState" value="<?php echo $datatwo["switchLocationState"]; ?>" id="requirePhone"
                                   type="text"
                                   class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
                        </div>
                        <div class="mt-2">
                            <label class="text-gray-700 dark:text-gray-200 mt-2" for="requirePhone">increaseTime</label>
                            <input required name="increaseTimeState" value="<?php echo $datatwo["increaseTimeState"]; ?>" id="requirePhone"
                                   type="text"
                                   class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
                        </div>
                        <div class="mt-2">
                            <label class="text-gray-700 dark:text-gray-200 mt-2" for="requirePhone">increaseVolume</label>
                            <input required name="increaseVolumeState" value="<?php echo $datatwo["increaseVolumeState"]; ?>" id="requirePhone"
                                   type="text"
                                   class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
                        </div>
                        <div class="mt-2">
                            <label class="text-gray-700 dark:text-gray-200 mt-2" for="requirePhone">subLink</label>
                            <input required name="subLinkState" value="<?php echo $datatwo["subLinkState"]; ?>" id="requirePhone"
                                   type="text"
                                   class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
                        </div>
                        <div class="mt-2">
                            <label class="text-gray-700 dark:text-gray-200 mt-2" for="requirePhone">weswap</label>
                            <input required name="weSwapState" value="<?php echo $datatwo["weSwapState"]; ?>" id="requirePhone"
                                   type="text"
                                   class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
                        </div>
                        <div class="mt-2">
                            <label class="text-gray-700 dark:text-gray-200 mt-2" for="requirePhone">Desired plan</label>
                            <input required name="plandelkhahState" value="<?php echo $datatwo["plandelkhahState"]; ?>" id="requirePhone"
                                   type="text"
                                   class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
                        </div>
                        <div class="mt-2">
                            <label class="text-gray-700 dark:text-gray-200 mt-2" for="username">lockChannel</label>
                            <input required name="lockChannel" value="<?php echo $datatwo["lockChannel"]; ?>" id="username"
                                   type="text"
                                   class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
                        </div>
                        <div class="mt-2">
                            <label class="text-gray-700 dark:text-gray-200 mt-2" for="username">rewardChannel</label>
                            <input required name="rewardChannel" value="<?php echo $datatwo["rewardChannel"]; ?>" id="username"
                                   type="text"
                                   class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
                        </div>
                        <div class="mt-2">
                            <label class="text-gray-700 dark:text-gray-200 mt-2" for="username">rewaredTime</label>
                            <input required name="rewaredTime" value="<?php echo $datatwo["rewaredTime"]; ?>" id="username"
                                   type="text"
                                   class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
                        </div>
                        <div class="mt-2">
                            <label class="text-gray-700 dark:text-gray-200 mt-2" for="requirePhone">GB-price</label>
                            <input required name="gbPrice" value="<?php echo $datatwo["gbPrice"]; ?>" id="requirePhone"
                                   type="text"
                                   class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
                        </div>
                        <div class="mt-2">
                            <label class="text-gray-700 dark:text-gray-200 mt-2" for="requirePhone">Day-price</label>
            ...
            <section style='margin-top:40px' class="w-full p-6 mx-auto bg-white rounded-md shadow-sm dark:bg-gray-800">
                ...
                <form id="save_pay">
                    <div class="grid grid-cols-1 gap-6 mt-4 xl:grid-cols-4 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 text-left" style="font-size: 14px">
                        <div class="mt-2">
                            <label class="text-gray-700 dark:text-gray-200 mt-2" for="username">zarinpal</label>
                            <input required name="zarin_name" value="<?php echo $data["zarinpal"]; ?>" id="username"
                                   type="text"
                                   class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
                        </div>
                        <div class="mt-2">
                            <label class="text-gray-700 dark:text-gray-200 mt-2" for="username">nextpay</label>
                            <input required name="nextpay_name" value="<?php echo $data["nextpay"]; ?>" id="username"
                                   type="text"
                                   class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
                        </div>
                        <div class="mt-2">
                            <label class="text-gray-700 dark:text-gray-200 mt-2" for="username">nowpayment - weswap</label>
                            <input required name="nowpayment_name" value="<?php echo $data["nowpayment"]; ?>" id="username"
                                   type="text"
                                   class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
                        </div>
<!--                        <div class="mt-2">-->
<!--                            <label class="text-gray-700 dark:text-gray-200 mt-2" for="username">weswap</label>-->
<!--                            <input required name="nowpayment_name" value="--><?php //echo $data["nowpayment"]; ?><!--" id="username"-->
<!--                                   type="text"-->
<!--                                   class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">-->
<!--                        </div>-->
                        <div class="mt-2">
                            <label class="text-gray-700 dark:text-gray-200 mt-2" for="username">holderName</label>
                            <input required name="holderName_name" value="<?php echo $data["holderName"]; ?>" id="username"
                                   type="text"
                                   class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
                        </div>
                        <div class="mt-2">
                            <label class="text-gray-700 dark:text-gray-200 mt-2" for="username">bankAccount</label>
                    ...
                    <div class="flex justify-end mt-6">
                        <button name="save_pay" type="submit"
                                class="px-8 py-2.5 leading-5 transition-colors duration-300 transform">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="#b298dc" viewBox="0 0 24 24" width="25"
                                 height="25">
                                <g id="_01_align_center" data-name="01 align center">
            ...
            <section class="mt-5 w-full p-6 mx-auto bg-white rounded-md shadow-sm dark:bg-gray-800">
                <form id="save_admin">
                    ...
                    <div class="grid grid-cols-1 gap-6 mt-4 xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 text-left" style="font-size: 14px">
                        <div class="mt-2">
                            <label class="text-gray-700 dark:text-gray-200 mt-2" for="username">Username</label>
                            <input required name="username" value="<?php echo $value["username"]; ?>" id="username"
                                   type="text"
                                   class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
                        </div>
                        <div class="mt-2">
                            <label class="text-gray-700 dark:text-gray-200 mt-2" for="username">Password</label>
            ...
            <section class="mt-5 w-full p-6 mx-auto bg-white rounded-md shadow-sm dark:bg-gray-800">
                <form id="save_backup">
                    ...
                    <div class="grid grid-cols-1 gap-6 mt-4 xl:grid-cols-4 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 text-left" style="font-size: 14px">
                        <div class="mt-2">
                            <label class="text-gray-700 dark:text-gray-200 mt-2" for="username">backup Channel id</label>
